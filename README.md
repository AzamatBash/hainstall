...
| Image | Tags | Role |
|-------|------|------|
| `azamatbash/hapanel` | `0.1.0`, `latest` | Panel (UI + API). **Prod digest:** `sha256:cefbedd99b5b5de35eef2346ad919322e2dde33544417365731b5693e53ba9cb` (см. `deploy/panel/PROD_IMAGE.txt`) |
